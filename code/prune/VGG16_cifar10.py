...
class PrunningFineTuner_VGG16:
    ...
    def __init__(self, train_path, test_path, model, use_gpu, torch_version = 0.4):
        ...
        if use_gpu:
            #pin_memory=True
            pin_memory = False #changed 2019/1/10 when this file is running
        else:
            pin_memory=False
    ...
    def prune(self, num = -1):
        ...
        if True:
            ...
            # last_acc = self.train(optimizer, epoches=10)
                torch.save(model,"./pruned/vgg16_cifar10_%d_prunned_%d" % (num,it_k))
...
def get_args():
    ...
    parser.add_argument("--train_epoch", dest="train_epoch", action="store", type=int, default=10)
